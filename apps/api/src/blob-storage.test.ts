 ...
 * Blob Storage Tests
 *
 * Tests filesystem blob storage implementation.
 */
...
describe('FilesystemBlobStorage', () => {
  ...
  beforeEach(async () => {
    ...
    testDir = join(tmpdir(), `regintel-test-${Date.now()}`);
