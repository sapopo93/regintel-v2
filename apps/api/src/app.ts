...
import { selectQuestion } from './mock-question-bank';
import {
  generateAlerts,
  deduplicateAlerts,
  capAlerts,
...
export const TOPICS = [
  // ─── SAFE (S1–S8) ──────────────────────────────────────────────────────────
  {
    ...
    regulationSectionId: 'SAF S1',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT, EvidenceType.TRAINING],
    questionMode: 'evidence_first' as const,
    maxFollowUps: 4,
  },
  {
    id: 'safe-systems-pathways-transitions',
    safQsId: 'S2',
    title: 'Safe Systems, Pathways and Transitions',
    regulationSectionId: 'SAF S2',
  ...
  {
    id: 'involving-people-manage-risks',
    safQsId: 'S4',
    title: 'Involving People to Manage Risks',
    regulationSectionId: 'SAF S4',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'evidence_first' as const,
    maxFollowUps: 4,
  },
  {
    ...
    regulationSectionId: 'SAF S5',
    evidenceRequirements: [EvidenceType.AUDIT, EvidenceType.CERTIFICATE],
    questionMode: 'evidence_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'safe-effective-staffing',
    safQsId: 'S6',
    title: 'Safe and Effective Staffing',
    regulationSectionId: 'SAF S6',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.TRAINING, EvidenceType.CERTIFICATE, EvidenceType.SKILLS_MATRIX, EvidenceType.SUPERVISION, EvidenceType.ROTA],
    questionMode: 'evidence_first' as const,
    maxFollowUps: 5,
  },
  {
  ...
  },
  {
    ...
    regulationSectionId: 'SAF E2',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.TRAINING, EvidenceType.AUDIT],
    questionMode: 'evidence_first' as const,
    maxFollowUps: 4,
  },
  {
    id: 'staff-teams-work-together',
    safQsId: 'E3',
    title: 'How Staff, Teams and Services Work Together',
    regulationSectionId: 'SAF E3',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'supporting-healthier-lives',
    safQsId: 'E4',
    title: 'Supporting People to Live Healthier Lives',
    regulationSectionId: 'SAF E4',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'monitoring-improving-outcomes',
    safQsId: 'E5',
    title: 'Monitoring and Improving Outcomes',
    regulationSectionId: 'SAF E5',
  ...
  // ─── CARING (C1–C5) ──────────────────────────────────────────────────────
  {
    id: 'kindness-compassion-dignity',
    safQsId: 'C1',
    title: 'Kindness, Compassion and Dignity',
    regulationSectionId: 'SAF C1',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.TRAINING, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 4,
  },
  {
    id: 'treating-people-as-individuals',
    safQsId: 'C2',
    title: 'Treating People as Individuals',
    regulationSectionId: 'SAF C2',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'independence-choice-control',
    safQsId: 'C3',
    title: 'Independence, Choice and Control',
    regulationSectionId: 'SAF C3',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'responding-immediate-needs',
    safQsId: 'C4',
    title: 'Responding to People\'s Immediate Needs',
    regulationSectionId: 'SAF C4',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'workforce-wellbeing-enablement',
    safQsId: 'C5',
    title: 'Workforce Wellbeing and Enablement',
    regulationSectionId: 'SAF C5',
  ...
  // ─── RESPONSIVE (R1–R7) ──────────────────────────────────────────────────
  {
    ...
    regulationSectionId: 'SAF R1',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 4,
  },
  {
    id: 'care-continuity-integration',
    safQsId: 'R2',
    title: 'Care Provision, Integration and Continuity',
    regulationSectionId: 'SAF R2',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'providing-information',
    safQsId: 'R3',
    title: 'Providing Information',
    regulationSectionId: 'SAF R3',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'listening-involving-people',
    safQsId: 'R4',
    title: 'Listening to and Involving People',
    regulationSectionId: 'SAF R4',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'evidence_first' as const,
    maxFollowUps: 4,
  },
  {
    ...
    regulationSectionId: 'SAF R5',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.TRAINING, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'equity-experiences-outcomes',
    safQsId: 'R6',
    title: 'Equity in Experiences and Outcomes',
    regulationSectionId: 'SAF R6',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'planning-for-future',
    safQsId: 'R7',
    title: 'Planning for the Future',
    regulationSectionId: 'SAF R7',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.TRAINING, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 4,
  },
  ...
  },
  {
    ...
    regulationSectionId: 'SAF W4',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.TRAINING, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'governance-management-sustainability',
    safQsId: 'W5',
    title: 'Governance, Management and Sustainability',
    regulationSectionId: 'SAF W5',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'evidence_first' as const,
    maxFollowUps: 5,
  },
  {
    id: 'partnerships-communities',
    safQsId: 'W6',
    title: 'Partnerships and Communities',
    regulationSectionId: 'SAF W6',
    evidenceRequirements: [EvidenceType.POLICY, EvidenceType.AUDIT],
    questionMode: 'narrative_first' as const,
    maxFollowUps: 3,
  },
  {
    id: 'learning-improvement-innovation',
    safQsId: 'W7',
    title: 'Learning, Improvement and Innovation',
    regulationSectionId: 'SAF W7',
...
// SAF 34 regulation key mappings for topics — 1:1 with Quality Statements
const SAF34_TOPIC_REGULATION_KEYS: Record<string, string[]> = {
  'learning-culture': ['CQC:REG:SAFE_CARE', 'CQC:QS:SAFE'],
  'safe-systems-pathways-transitions': ['CQC:REG:SAFE_CARE', 'CQC:QS:SAFE'],
  'safeguarding': ['CQC:REG:SAFEGUARDING', 'CQC:QS:SAFE'],
  'involving-people-manage-risks': ['CQC:REG:SAFE_CARE', 'CQC:QS:SAFE'],
  'safe-environments': ['CQC:REG:PREMISES', 'CQC:QS:SAFE'],
  'safe-effective-staffing': ['CQC:REG:STAFFING', 'CQC:QS:SAFE'],
  'infection-prevention-control': ['CQC:REG:SAFE_CARE', 'CQC:QS:SAFE', 'CQC:REG:IPC'],
  'medicines-optimisation': ['CQC:REG:SAFE_CARE', 'CQC:QS:SAFE', 'CQC:REG:MEDICINES'],
  'assessing-needs': ['CQC:REG:PERSON_CENTRED', 'CQC:QS:EFFECTIVE'],
  'evidence-based-care': ['CQC:REG:SAFE_CARE', 'CQC:QS:EFFECTIVE'],
  'staff-teams-work-together': ['CQC:REG:STAFFING', 'CQC:QS:EFFECTIVE'],
  'supporting-healthier-lives': ['CQC:REG:PERSON_CENTRED', 'CQC:QS:EFFECTIVE'],
  'monitoring-improving-outcomes': ['CQC:REG:GOVERNANCE', 'CQC:QS:EFFECTIVE'],
  'consent-to-care': ['CQC:REG:CONSENT', 'CQC:QS:EFFECTIVE'],
  'kindness-compassion-dignity': ['CQC:REG:DIGNITY', 'CQC:QS:CARING'],
  'treating-people-as-individuals': ['CQC:REG:PERSON_CENTRED', 'CQC:QS:CARING'],
  'independence-choice-control': ['CQC:REG:DIGNITY', 'CQC:QS:CARING'],
  'responding-immediate-needs': ['CQC:REG:PERSON_CENTRED', 'CQC:QS:CARING'],
  'workforce-wellbeing-enablement': ['CQC:REG:STAFFING', 'CQC:QS:CARING'],
  'person-centred-care': ['CQC:REG:PERSON_CENTRED', 'CQC:QS:RESPONSIVE'],
  'care-continuity-integration': ['CQC:REG:PERSON_CENTRED', 'CQC:QS:RESPONSIVE'],
  'providing-information': ['CQC:REG:DUTY_OF_CANDOUR', 'CQC:QS:RESPONSIVE'],
  'listening-involving-people': ['CQC:REG:COMPLAINTS', 'CQC:QS:RESPONSIVE'],
  'equity-in-access': ['CQC:REG:PERSON_CENTRED', 'CQC:QS:RESPONSIVE'],
  'equity-experiences-outcomes': ['CQC:REG:PERSON_CENTRED', 'CQC:QS:RESPONSIVE'],
  'planning-for-future': ['CQC:REG:PERSON_CENTRED', 'CQC:QS:RESPONSIVE'],
  'shared-direction-culture': ['CQC:REG:GOVERNANCE', 'CQC:QS:WELL_LED'],
  'capable-compassionate-leaders': ['CQC:REG:GOVERNANCE', 'CQC:QS:WELL_LED'],
  'freedom-to-speak-up': ['CQC:REG:GOVERNANCE', 'CQC:QS:WELL_LED'],
  'workforce-edi': ['CQC:REG:STAFFING', 'CQC:QS:WELL_LED'],
  'governance-management-sustainability': ['CQC:REG:GOVERNANCE', 'CQC:QS:WELL_LED'],
  'partnerships-communities': ['CQC:REG:GOVERNANCE', 'CQC:QS:WELL_LED'],
  'learning-improvement-innovation': ['CQC:REG:GOVERNANCE', 'CQC:QS:WELL_LED'],
  'environmental-sustainability': ['CQC:REG:PREMISES', 'CQC:QS:WELL_LED'],
};
  ...
  app.get('/v1/facilities/:facilityId/readiness-journey', asyncRoute(async (req, res) => {
    ...
    const steps = [
      ...
      },
      {
        ...
        actionHref: hasCqcReport ? undefined : `/locations/${encodeURIComponent(facilityId)}?${facilityQuery}`,
      ...
      },
      {
        ...
        actionHref: evidence.length > 0 ? undefined : `/locations/${encodeURIComponent(facilityId)}?${facilityQuery}`,
      ...
      },
      {
        ...
        actionHref: evidence.length < 3 ? `/locations/${encodeURIComponent(facilityId)}?${facilityQuery}` : undefined,
